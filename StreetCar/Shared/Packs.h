...
enum packs {
  ...
  INITGAME, PLAYEDTILE, PLAYEDTRAVEL, STARTEDTRAVEL, STOPPEDTRAVEL, VALIDATION, WON, PILEPLAYER, NEWPLAYERADD,YOURIDPLAYER, GOAL,LAUNCH, RESPONSEREFRESH, GAMECREATENETWORK,
    // ONLY SERVER
    CIRCULARQUEUECLIENT
};
