...
QT_MOC_LITERAL(7, 57, 8)
    ...
    "LoadWindow\0loadGame\0\0Game\0indexMoved\0"
    "index\0doubleClicked\0slotLoad\0"
};
...
void LoadWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->loadGame((*reinterpret_cast< Game(*)>(_a[1]))); break;
        case 1: _t->indexMoved((*reinterpret_cast< QModelIndex(*)>(_a[1]))); break;
        case 2: _t->doubleClicked((*reinterpret_cast< QModelIndex(*)>(_a[1]))); break;
        case 3: _t->slotLoad(); break;
        default: ;
        }
        ...
        {
            typedef void (LoadWindow::*_t)(Game );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LoadWindow::loadGame)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void LoadWindow::loadGame(Game _t1)
{
